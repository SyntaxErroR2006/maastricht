...
client.on("ready", async () => {
    ...
    let activities = ["Maastricht", "Prefix -", ]
    i = 0;
    setInterval(() => {
...
client.on("guildMemberAdd", member => {
    ...
    var role = member.guild.roles.cache.get('780493844420100101');

    if (!role) return;

    member.roles.add(role);

    var channel = member.guild.channels.cache.get('780493845074542642');
